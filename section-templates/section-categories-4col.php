			...
			<li class="sc-first-post sc-title-hover sc-item">
				...
				<div class="sc-entry">
					...
					<aside class="s-info clearfix">
						...
						<?php if( $sau ) { ?><a href="<?php echo esc_url( get_author_posts_url( get_the_author_meta( 'ID' ) ) ); ?>" id="gallery-author" class="category"><?php echo esc_html( get_the_author() ); ?></a><?php } ?>
					</aside>
					<?php } ?>
