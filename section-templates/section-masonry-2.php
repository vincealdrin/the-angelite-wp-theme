...
<header class="section-col-header twelvecol">
	<h1 id="gallery-title" class="section-col-title">
		<a href="<?= get_post_format_link('image'); ?>">
...
<div id="sm-<?php echo absint( $wnum ); ?>-large" class="js-masonry twelvecol" style="display: none;" data-masonry-options='{ "columnWidth": ".grid-sizer-large", "percentPosition": true, "itemSelector": ".col-large" }'>
    ...
    <?php
        ...
        } elseif(  $section_type == 'image_type' ) {
            // Posts in image type
            $query_args = array(
                'posts_per_page'		=> 4,
				'post_status'         	=> 'publish',
            ...
            <figcaption class="st-overlay">
                ...
                <div class="st-title-wrap">
                    ...
                    <aside class="s-info clearfix">
                        ...
                        <?php if( $sau && ( $section_type != 'posts' && $section_type != 'featured' ) ) { ?><a href="<?php echo esc_url( get_author_posts_url( get_the_author_meta( 'ID' ) ) ); ?>" id="gallery-author" class="category"><?php echo esc_html( get_the_author() ); ?></a><?php } ?>
